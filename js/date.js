...
arrM[337] = '벨레스 미궁(가슴) / 발사기지'; 
arrM[338] = '숨겨진 공허 (머리) / 유로파'; 
arrM[339] = '벙커 E15 (다리) / 유로파'; 
arrM[340] = '파멸 (팔) / 유로파'; 
arrM[341] = '엑소더스정원2A (가슴) / 발사기지'; 
arrM[342] = '벨레스 미궁(머리) / 발사기지';  
arrM[343] = '숨겨진 공허 (다리) / 유로파'; 
arrM[344] = '벙커 E15 (팔) / 유로파'; //10
arrM[345] = '파멸 (가슴) / 유로파'; 
arrM[346] = '엑소더스정원2A (머리) / 발사기지';  
arrM[347] = '벨레스 미궁(다리) / 발사기지'; 
arrM[348] = '숨겨진 공허 (팔) / 유로파'; 
arrM[349] = '벙커 E15 (가슴) / 유로파'; //15
arrM[350] = '파멸 (머리) / 유로파'; 
arrM[351] = '엑소더스정원2A (다리) / 발사기지';  
arrM[352] = '벨레스 미궁(팔) / 발사기지'; 
arrM[353] = '숨겨진 공허 (가슴) / 유로파'; 
arrM[354] = '벙커 E15 (머리) / 유로파'; //20
arrM[355] = '파멸 (다리) / 유로파'; 
arrM[356] = '엑소더스정원2A (팔) / 발사기지';  
arrM[357] = '벨레스 미궁(가슴) / 발사기지'; 
arrM[358] = '숨겨진 공허 (머리) / 유로파'; 
arrM[359] = '벙커 E15 (다리) / 유로파'; //25
arrM[360] = '파멸 (팔) / 유로파'; 
arrM[361] = '엑소더스정원2A (가슴) / 발사기지';  
arrM[362] = '벨레스 미궁(머리) / 발사기지'; 
arrM[363] = '숨겨진 공허 (다리) / 유로파'; 
arrM[364] = '벙커 E15 (팔) / 유로파'; //30
